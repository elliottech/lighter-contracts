...
/// @title zkLighter Batch Verifier Contract
/// @author zkLighter Team
/// @dev This contract is generated by gnark for zkLighter circuit's verification key with few modifications.
///   - The contract is made upgradeable.
contract ZkLighterVerifier is IZkLighterVerifier {
  // ------ UPGRADAABLE START ------
  ...
  uint256 private constant VK_QL_COM_X = 17824093704844824222396284333896983282347614990157081653522732752688483042288;
  uint256 private constant VK_QL_COM_Y = 10464669379262065879311800277126626150351103308125238285069273695846550585637;
  uint256 private constant VK_QR_COM_X = 12088248911194308362810172625516790867965097460927358278567800546402299977309;
  uint256 private constant VK_QR_COM_Y = 7201892824079490620827471898888670789043188522835172323964942245844791367890;
  uint256 private constant VK_QM_COM_X = 11930930793322212599480909285987685197077655339170121811621420149035139306348;
  uint256 private constant VK_QM_COM_Y = 6933678991161769299462259010973880934623069185781261736081907921656167079250;
  uint256 private constant VK_QO_COM_X = 6646946910932738331828074625672273446913414212244304092081245140091706749792;
  uint256 private constant VK_QO_COM_Y = 6569170690910281115630445341456861696714254996605198285358754083920277471242;
  uint256 private constant VK_QK_COM_X = 11205550953316166407277481552314818553527744821915433036167852790075233879263;
  uint256 private constant VK_QK_COM_Y = 13517829565087722517903049932500907262817821877551793205786765980712420392446;

  uint256 private constant VK_S1_COM_X = 17118498206529573367976043622417036717391532435918563718589878518988347279282;
  uint256 private constant VK_S1_COM_Y = 10280732876456417519521694382787630582303663660829625302386651882422208482994;

  uint256 private constant VK_S2_COM_X = 5550299705604401790957721038137020595817784831712292824769609251822441481770;
  uint256 private constant VK_S2_COM_Y = 13601598305240167517383125700198287392392040059899334519920288770165049046551;

  uint256 private constant VK_S3_COM_X = 1152349248254494148196899935507004693041282683553779186451310165972696524395;
  uint256 private constant VK_S3_COM_Y = 4186592922881705227203781408454732496567700716792118179291196416552729074691;

  uint256 private constant VK_COSET_SHIFT = 5;

  uint256 private constant VK_QCP_0_X = 4425885100796931047356908570978664049604087624150480002749109225575608097085;
  uint256 private constant VK_QCP_0_Y = 8863349859401504937958455461496816099905885198254382707533444893575979450513;

  uint256 private constant VK_INDEX_COMMIT_API_0 = 10074301;
